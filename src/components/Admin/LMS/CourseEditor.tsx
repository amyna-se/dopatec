  ...
  const handleSaveQuestion = (question: Question) => {
    if (editingCourse) {
      const updatedQuestions = editingQuestion 
        ? editingCourse.questions.map((q: Question) => q.id === editingQuestion.id ? question : q)
            ...
            {expandedCourse === courseId && (
              <div className="p-4 border-t border-neon-blue/10">
                <div className="space-y-2">
                  {course.questions?.map((question: Question, index: number) => (
                    <div
                      key={question.id}
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {editingCourse.questions.map((question: Question, index: number) => (
                    <div
                      key={question.id}
                      className="flex items-center justify-between p-3 bg-dark rounded-lg"
                    >
